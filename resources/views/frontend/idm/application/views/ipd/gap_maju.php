    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="box box-primary">
          ...
          <div class="box-body">
            GAP Analisis merupakan teknik yang digunakan untuk mengetahui kesenjangan antara kondisi aktual di suatu desa dengan kondisi rata-rata status perdesaan yang diinginkan dalam suatu provinsi. Balok Biru menunjukkan kondisi aktual dari desa <b><?php echo $desa; ?></b>. Garis Kuning menunjukkan kondisi rata-rata desa yang berstatus desa maju dari Provinsi. 
			Untuk menjadi Desa <b>Maju Nasional</b> yang dalam hal ini menggunakan <b>Centroid Cluster 2 Nasional</b>, tabel program prioritas pembangunan desa dibawah ini dapat digunakan sebagai acuan..
          </div><!-- /.box-body -->
        </div><!-- /.box -->
      </div><!-- /.col -->
    </div><!-- /.row -->
