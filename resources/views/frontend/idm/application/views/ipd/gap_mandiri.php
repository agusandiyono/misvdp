<?php foreach ($centroid_mandiri as $key){
  $distance = array(
   $akhir1= $key->I1-$i1,
   $akhir2= $key->I2-$i2,
   $akhir3= $key->I3-$i3,
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="box box-primary">
          ...
          <div class="box-body">
            GAP Analisis merupakan teknik yang digunakan untuk mengetahui kesenjangan antara kondisi aktual di suatu desa dengan kondisi rata-rata status perdesaan yang diinginkan dalam suatu provinsi. Balok Biru menunjukkan kondisi aktual dari desa <b><?php echo $desa; ?></b>. Garis Kuning menunjukkan kondisi rata-rata desa yang berstatus desa Mandiri dari Provinsi. 
			Untuk menjadi Desa <b><?php echo $key->cluster ?> Nasional</b> yang dalam hal ini menggunakan <b>Centroid Cluster 1 Nasional</b>, tabel program prioritas pembangunan desa dibawah ini dapat digunakan sebagai acuan.
  ...
  var chart = AmCharts.makeChart("chartdiv2", {
    ...
    "dataProvider": [{
      ...
      },
      {
          ...
          "mandiri": "<?php echo getMandiri($provinsi,'I2'); ?>"
      },
      {
          "judul": "i3",
