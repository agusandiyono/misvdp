	...
	<form role="form" method="post" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="no_urut" name="data[no_urut]" data-validate="required" data-message-required="Kolom nomor urut kelompok tidak boleh kosong." placeholder="No. Kelompok" value="<?php echo $evkin->no_urut ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="nama" class="col-sm-3 control-label">Nama Kelompok</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="nama" name="data[nama]" data-validate="required" data-message-required="Kolom nama kelompok tidak boleh kosong." placeholder="Nama Kelompok" value="<?php echo $evkin->nama ?>">
			</div>
		</div>
		<div class="form-group">
