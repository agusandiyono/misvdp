<?php 
foreach ($mandiri_nasional as $key){
  $distance = array(
...
<section class="content-header">
  ...
  <button onclick="tableToExcel('testTable', 'GAP Mandiri Nasional')" class="btn btn-green btn-icon icon-left">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="box box-primary">
          ...
          <div class="box-body">
            GAP Analisis merupakan teknik yang digunakan untuk mengetahui kesenjangan antara kondisi aktual di suatu desa dengan kondisi rata-rata status perdesaan yang diinginkan dalam suatu provinsi. Balok Biru menunjukkan kondisi aktual dari desa <b><?php echo $desa; ?></b>. Garis Merah menunjukkan kondisi rata-rata desa yang berstatus desa Mandiri Nasional.
            Untuk menjadi Desa Mandiri Nasional dengan mengikuti urutan Program Prioritas yang ada di tabel <b>PROGRAM PRIORITAS PEMBANGUNAN DESA</b> di bawah.<br >
