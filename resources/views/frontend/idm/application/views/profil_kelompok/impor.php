		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><strong>Impor Profil Kelompok</strong></h4>
				</div>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								...
								<?php endif ?>
								<select name="provinsi" class="form-control" data-validate="required" data-message-required="Kolom nama provinsi tidak boleh kosong." id="provinsi_id" placeholder="Provinsi" <?php echo !empty($this->session->userdata('provinsi_id')) ? 'disabled' : "" ?>>
									<option></option>
						...
						<p><strong><a href="<?php echo base_url('uploads/Format Impor Profil Kelompok.xlsx') ?>">Klik untuk download format impor profil kelompok.</a></strong></p>
					</div>
		...
		<script>
			jQuery(document).ready(function($){
				...
				$('#kabupaten_id').select2({
					...
					minimumResultsForSearch: 10,
					ajax: {
						url: "<?php echo base_url('profil_kelompok/get_lokasi') ?>",
						dataType: 'json',
