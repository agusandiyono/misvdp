		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><strong>Impor RKPDES</strong></h4>
				</div>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								...
								<?php endif ?>
								<select name="provinsi" class="form-control" data-validate="required" data-message-required="Kolom provinsi tidak boleh kosong." id="provinsi_id" placeholder="Provinsi" <?php echo !empty($this->session->userdata('provinsi_id')) ? 'disabled' : "" ?>>
									<option></option>
						...
						<p><strong><a href="<?php echo base_url('uploads/Format Impor RKPDES.xlsx') ?>">Klik untuk download format impor RKPDES.</a></strong></p>
					</div>
