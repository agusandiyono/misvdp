	...
	<form role="form" method="post" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				...
				<?php foreach ($list_provinsi as $provinsi): ?>
					<option value="<?php echo $provinsi->provinsi_code ?>" <?php echo $provinsi->provinsi_code == $rkpdes->provinsi_id ? "selected" : "" ?>><?php echo $provinsi->provinsi_code ?> - <?php echo $provinsi->provinsi_name ?></option>
				<?php endforeach ?>
				</select>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="jumlah_dana_desa" name="data[jumlah_dana_desa]" placeholder="Jumlah Dana Desa" value="<?php echo $rkpdes->jumlah_dana_desa ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="jumlah_alokasi_dana_desa" class="col-sm-3 control-label">Jumlah Alokasi Dana Desa</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="jumlah_alokasi_dana_desa" name="data[jumlah_alokasi_dana_desa]" placeholder="Jumlah Alokasi Dana Desa" value="<?php echo $rkpdes->jumlah_alokasi_dana_desa ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="jenis" class="col-sm-3 control-label">Jenis Kegiatan Pertanian</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="jenis" name="data[jenis]" placeholder="Jenis Kegiatan Pertanian" value="<?php echo $rkpdes->jenis ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="volume" class="col-sm-3 control-label">Volume</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="volume" name="data[volume]" placeholder="Volume" value="<?php echo $rkpdes->volume ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="nilai" class="col-sm-3 control-label">Nilai</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="nilai" name="data[nilai]" placeholder="Nilai" value="<?php echo $rkpdes->nilai ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="sumber_dana_desa" class="col-sm-3 control-label">Sumber Dana Desa</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="sumber_dana_desa" name="data[sumber_dana_desa]" placeholder="Sumber Dana Desa" value="<?php echo $rkpdes->sumber_dana_desa ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="sumber_alokasi_dana_desa" class="col-sm-3 control-label">Sumber Alokasi Dana Desa</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="sumber_alokasi_dana_desa" name="data[sumber_alokasi_dana_desa]" placeholder="Sumber Alokasi Dana Desa" value="<?php echo $rkpdes->sumber_alokasi_dana_desa ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="persentase" class="col-sm-3 control-label">Persentase Dana Dari Desa</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="persentase" name="data[persentase]" placeholder="Persentase Dana Dari Desa" value="<?php echo $rkpdes->persentase ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="pengelola" class="col-sm-3 control-label">Pengelola Dana Desa</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="pengelola" name="data[pengelola]" placeholder="Pengelola Dana Desa" value="<?php echo $rkpdes->pengelola ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="keterangan" class="col-sm-3 control-label">Keterangan</label>
			<div class="col-sm-5">
				<textarea class="form-control" name="data[keterangan]" id="keterangan" rows="5"><?php echo $rkpdes->keterangan ?></textarea>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		//		minimumInputLength: 3,
			...
			<?php if(!empty($rkpdes->kabupaten)): ?> $('#kabupaten_id').select2('data', <?php echo json_encode($rkpdes->kabupaten) ?>); <?php endif ?>
			<?php if(!empty($rkpdes->kecamatan)): ?> $('#kecamatan_id').select2('data', <?php echo json_encode($rkpdes->kecamatan) ?>); <?php endif ?>
			<?php if(!empty($rkpdes->desa)): ?> $('#desa_id').select2('data', <?php echo json_encode($rkpdes->desa) ?>); <?php endif ?>
		});
	</script>