		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><strong>Impor Evaluasi Kinerja</strong></h4>
				</div>
				<form role="form" method="post" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data">
					<div class="modal-body">
						...
						<p><strong><a href="<?php echo base_url('uploads/Format Impor Evaluasi Kinerja.xlsx') ?>">Klik untuk download format impor evaluasi kinerja.</a></strong></p>
					</div>
