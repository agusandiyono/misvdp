	...
	<form role="form" method="post" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="no_urut" name="data[no_urut]" placeholder="No. Kelompok">
			</div>
		</div>
		<div class="form-group">
			<label for="nama" class="col-sm-3 control-label">Nama Kelompok</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="nama" name="data[nama]" placeholder="Nama Kelompok">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="operasional_pnpm_opsi" class="col-sm-3 control-label">Program PPDM?</label>
			<div class="col-sm-2">
		...
		<h5>Sebelum Program PPDM Mpd Pertanian</h5>
		<div class="form-group">
		...
		<h5>Setelah Program PPDM Mpd Pertanian</h5>
		<div class="form-group">
