...
<table class="table table-bordered datatable">
  <tbody>
    ...
    <tr>
      <td>		
        <?php echo anchor(site_url('idm/gap_berkembang/'.$id), 'Berkembang <br> Cluster 3',array('class'=>'btn btn-warning btn-sm'));?>
		<?php echo anchor(site_url('idm/gap_maju/'.$id), 'Maju <br> Cluster 2',array('class'=>'btn btn-success btn-sm'));?>
        <?php echo anchor(site_url('idm/gap_mandiri/'.$id), 'Mandiri <br> Cluster 1',array('class'=>'btn btn-danger btn-sm'));?>
		<?php echo anchor(site_url('idm/berkembang_nasional/'.$id), 'Berkembang <br> Nasional',array('class'=>'btn btn-primary btn-sm'));?>
		<?php echo anchor(site_url('idm/mandiri_nasional/'.$id), 'Mandiri <br> Nasional',array('class'=>'btn btn-info btn-sm'));?>
...
<a href="<?php echo base_url('idm') ?>" class="btn btn-lg btn-red pull-right"><i class="entypo-back"></i> Kembali</a>
</div>
