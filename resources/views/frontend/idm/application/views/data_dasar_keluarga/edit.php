	...
	<form role="form" method="post" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data">
		...
		<div class="form-group">
			<div class="col-md-12">
				<h3>1. IDENTITAS DESA</h3>
			</div>
		</div>
		<div class="form-group">
			<label for="nomor_kartu_keluarga" class="col-sm-3 control-label">101. Nama Informan</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="nomor_kartu_keluarga" name="data[nomor_kartu_keluarga]" placeholder="Nama Informan" value="<?php echo $ddk->nomor_kartu_keluarga ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="nama_kepala_keluarga" class="col-sm-3 control-label">102. Jabatan</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="nama_kepala_keluarga" name="data[nama_kepala_keluarga]" placeholder="Jabatan" value="<?php echo $ddk->nama_kepala_keluarga ?>">
			</div>
		</div>
			<div class="form-group">
			<label for="dusun" class="col-sm-3 control-label">103. No. Telepon Rumah / Hp</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="dusun" name="data[dusun]" placeholder="No. Telepon Rumah / Hp" value="<?php echo $ddk->dusun ?>" >
			</div>
		</div>
		<div class="form-group">
			<label for="tanggal" class="col-sm-3 control-label">104. Tanggal Lahir<span class="text-danger">*</span></label>
			<div class="col-sm-6">
				<input type="text" class="form-control datepicker" data-format="dd-mm-yyyy" id="tanggal" name="data[tanggal]" placeholder="Tanggal Lahir" value="<?php echo $ddk->tanggal ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="anggota1_jenis_kelamin" class="col-sm-3 control-label">105. Jenis Kelamin</label>
			<div class="col-sm-5">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="rtrw" name="data[rtrw]" placeholder="Garis Lintang" value="<?php echo $ddk->rtrw ?>"> <br>
				<input type="text" class="form-control" id="anggota1_galian_aluminium" name="data[anggota][0][galian][aluminium][pemasaran]" placeholder="Garis Bujur" value="<?php echo $ddk->anggota[0]["galian"]["aluminium"]["pemasaran"] ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="alamat" class="col-sm-3 control-label">111. Alamat Lengkap</label>
			<div class="col-sm-5">
				<textarea name="data[alamat]" id="alamat" rows="5" class="form-control" placeholder="Alamat Lengkap"><?php echo $ddk->alamat ?></textarea>
			</div>
		</div>
		<div class="form-group">
			<label for="pengisi" class="col-sm-3 control-label">112.a. Nama Kepala Desa</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="pengisi" name="data[detail][pengisi]" placeholder="Nama Kepala Desa" value="<?php echo $ddk->detail["pengisi"] ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_lahan_pangan" class="col-sm-3 control-label">112. b. Jenis Kelamin Kepala Desa</label>
			<div class="col-sm-5">
				<select class="form-control" name="data[detail][keluarga][lahan][pangan]" id="keluarga_lahan_pangan">
					...
					<option value="laki" <?php echo $ddk->detail["keluarga"]["lahan"]["pangan"] == "laki" ? "selected" : ""; ?>>Laki-laki</option>
					<option value="perempuan" <?php echo $ddk->detail["keluarga"]["lahan"]["pangan"] == "perempuan" ? "selected" : ""; ?>>Perempuan</option>
				</select>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="pekerjaan" name="data[detail][pekerjaan]" placeholder="No. Telepon Rumah / Hp Kepala Desa" value="<?php echo $ddk->detail["pekerjaan"] ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="jabatan" class="col-sm-3 control-label">114. No. Telepon Kantor Desa</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="jabatan" name="data[detail][jabatan]" placeholder="No. Telepon Kantor Desa" value="<?php echo $ddk->detail["jabatan"] ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="sumber_data" class="col-sm-3 control-label">115. Email Desa</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="sumber_data" name="data[detail][sumber_data][4]" placeholder="Email Desa" value="<?php echo $ddk->detail["sumber_data"]["4"] ?>">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-5">
				<select class="form-control" name="data[detail][keluarga][lahan][kebun]" id="keluarga_lahan_kebun">
					...
					<option value="Tamat S1 / D4 / D3 / sederajat" <?php echo $ddk->detail["keluarga"]["lahan"]["kebun"] == "laki" ? "selected" : ""; ?>>Tamat S1 / D4 / D3 / sederajat</option>
					<option value="Tamat SMA /sederajat"<?php echo $ddk->detail["keluarga"]["lahan"]["kebun"] == "laki" ? "selected" : ""; ?>>Tamat SMA /sederajat</option>
					<option value="Tamat SMP /sederajat"<?php echo $ddk->detail["keluarga"]["lahan"]["kebun"] == "laki" ? "selected" : ""; ?>>Tamat SMP /sederajat</option>
					<option value="Tamat SD /sederajat"<?php echo $ddk->detail["keluarga"]["lahan"]["kebun"] == "laki" ? "selected" : ""; ?>>Tamat SD /sederajat</option>
					<option value="TTidak sekolah"<?php echo $ddk->detail["keluarga"]["lahan"]["kebun"] == "laki" ? "selected" : ""; ?>>Tidak sekolah</option>
				</select>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_penyakit_keluarga_lainnya1" name="data[detail][keluarga][penyakit_keluarga][lainnya1][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_penyakit_keluarga_lainnya1" name="data[detail][keluarga][penyakit_keluarga][lainnya1][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_penyakit_keluarga_lainnya2" class="col-sm-3 control-label">b. Kepala Urusan tata usaha dan umum</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_penyakit_keluarga_lainnya2" name="data[detail][keluarga][penyakit_keluarga][lainnya2][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_penyakit_keluarga_lainnya2" name="data[detail][keluarga][penyakit_keluarga][lainnya2][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_penyakit_keluarga_lainnya3" class="col-sm-3 control-label">c. Kepala urusan keuangan</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_penyakit_keluarga_lainnya3" name="data[detail][keluarga][penyakit_keluarga][lainnya3][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_penyakit_keluarga_lainnya3" name="data[detail][keluarga][penyakit_keluarga][lainnya3][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_kerukunan_lainnya" class="col-sm-3 control-label">d. Kepala urusan perencanaan</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_kerukunan_lainnya" name="data[detail][keluarga][kerukunan][lainnya][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_kerukunan_lainnya" name="data[detail][keluarga][kerukunan][lainnya][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_perkelahian_lainnya1" name="data[detail][keluarga][perkelahian][lainnya1][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_perkelahian_lainnya1" name="data[detail][keluarga][perkelahian][lainnya1][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_perkelahian_lainnya2" class="col-sm-3 control-label">f. Kepala seksi kesejahteraan</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_perkelahian_lainnya2" name="data[detail][keluarga][perkelahian][lainnya2][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_perkelahian_lainnya2" name="data[detail][keluarga][perkelahian][lainnya2][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_miras_narkoba_lainnya" class="col-sm-3 control-label">g. Kepala seksi pelayanan</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_miras_narkoba_lainnya" name="data[detail][keluarga][miras_narkoba][lainnya][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_miras_narkoba_lainnya" name="data[detail][keluarga][miras_narkoba][lainnya][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_pembunuhan_lainnya" name="data[detail][keluarga][pembunuhan][lainnya][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_pembunuhan_lainnya" name="data[detail][keluarga][pembunuhan][lainnya][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_penculikan_lainnya1" name="data[detail][keluarga][penculikan][lainnya1][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_penculikan_lainnya1" name="data[detail][keluarga][penculikan][lainnya1][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_penculikan_lainnya2" class="col-sm-3 control-label">j. LPM dan Anggota</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_penculikan_lainnya2" name="data[detail][keluarga][penculikan][lainnya2][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_penculikan_lainnya2" name="data[detail][keluarga][penculikan][lainnya2][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_seksual_lainnya1" class="col-sm-3 control-label">k. TP. PKK Desa</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_seksual_lainnya1" name="data[detail][keluarga][seksual][lainnya1][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_seksual_lainnya1" name="data[detail][keluarga][seksual][lainnya1][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_seksual_lainnya2" class="col-sm-3 control-label">l. Kepala Dusun</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_seksual_lainnya2" name="data[detail][keluarga][seksual][lainnya2][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_seksual_lainnya2" name="data[detail][keluarga][seksual][lainnya2][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_kekerasan_lainnya" name="data[detail][keluarga][kekerasan][lainnya][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_kekerasan_lainnya" name="data[detail][keluarga][kekerasan][lainnya][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_penderita_sakit_lainnya1" class="col-sm-3 control-label">n. Ketua RT</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_penderita_sakit_lainnya1" name="data[detail][keluarga][penderita_sakit][lainnya1][keterangan]" placeholder="Jumlah Laki-Laki"><br>
				<input type="text" class="form-control" id="keluarga_penderita_sakit_lainnya1" name="data[detail][keluarga][penderita_sakit][lainnya1][jumlah]" placeholder="Jumlah Perempuan">
			</div>
		</div>
		<div class="form-group">
			<div class="col-md-12">
		...
		<div class="form-group">
			<label for="keluarga_jenis_ternak_kambing" class="col-sm-3 control-label">201. Total Luas Wilayah Desa</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_jenis_ternak_kambing" name="data[detail][keluarga][jenis_ternak][kambing]" placeholder="Total Luas Wilayah Desa">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="keluarga_jenis_ternak_angsa" class="col-sm-3 control-label">204. Jumlah Total Penduduk</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_jenis_ternak_angsa" name="data[detail][keluarga][jenis_ternak][angsa]" placeholder="Jumlah Total Penduduk">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_jenis_ternak_burung_puyuh" class="col-sm-3 control-label">205. Jumlah Penduduk Laki-laki</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_jenis_ternak_burung_puyuh" name="data[detail][keluarga][jenis_ternak][burung_puyuh]" placeholder="Jumlah Penduduk Laki-laki">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_jenis_ternak_kelinci" class="col-sm-3 control-label">206. Jumlah Penduduk Perempuan</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_jenis_ternak_kelinci" name="data[detail][keluarga][jenis_ternak][kelinci]" placeholder="Jumlah Penduduk Perempuan">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_jenis_ternak_burung_walet" class="col-sm-3 control-label">207. Jumlah penduduk pendatang</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_jenis_ternak_burung_walet" name="data[detail][keluarga][jenis_ternak][burung_walet]" placeholder="Jumlah penduduk pendatang">
			</div>
		</div>
		<div class="form-group">
			<label for="keluarga_jenis_ternak_anjing" class="col-sm-3 control-label">208. Jumlah penduduk pergi</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_jenis_ternak_anjing" name="data[detail][keluarga][jenis_ternak][anjing]" placeholder="Jumlah penduduk pergi">
			</div>
		</div>
		<div class="form-group">
			<div class="col-md-12">
		...
		<div class="form-group">
			<label for="keluarga_jenis_ternak_kucing" class="col-sm-3 control-label">209. Jumlah Total Kepala Keluarga </label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="keluarga_jenis_ternak_kucing" name="data[detail][keluarga][jenis_ternak][kucing]" placeholder="Jumlah Total Kepala Keluarga">
			</div>
		</div>
		<div class="form-group">
