				...
				*/
				...
				setTimeout(function()
				{
					...
					$.ajax({
						...
						dataType: 'json',
						data: {
							kemendesa_token: $("input#csrf").val(),
						...
						error: function()
						{
							...
							$(".form-login-error").html('<h3>Terjadi kesalahan</h3><p>Terjadi kesalahan saat masuk, silahkan coba lagi.</p>');
						...
						success: function(response)
						{
							...
							setTimeout(function()
							{
								...
								{
									$(".login-page").removeClass('logging-in');
									$(".form-login-error").html('<h3>Terjadi kesalahan</h3><p><strong>Nama Pengguna</strong> atau <strong>Password</strong> yang anda masukkan salah.</p>');
									neonLogin.resetProgressBar(true);
								}
