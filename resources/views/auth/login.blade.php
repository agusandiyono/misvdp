...
<form class="login-form" method="POST" action="{{ route('login') }}">
    ...
    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
        ...
        <input class="form-control form-control-solid placeholder-no-fix" id="email" type="text" autocomplete="off" value="{{ old('email') }}" required autofocus placeholder="Username/Email" name="email" /> 
        @if ($errors->has('email'))
